...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Profile CG Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.khronos.collada.ProfileCGType#getAsset <em>Asset</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getCode <em>Code</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getInclude <em>Include</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getGroup1 <em>Group1</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getImage <em>Image</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getNewparam <em>Newparam</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getTechnique <em>Technique</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getExtra <em>Extra</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getId <em>Id</em>}</li>
 *   <li>{@link org.khronos.collada.ProfileCGType#getPlatform <em>Platform</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.khronos.collada.ColladaPackage#getProfileCGType()
 * @model extendedMetaData="name='profile_CG_._type' kind='elementOnly'"
 * @generated
 */
public interface ProfileCGType extends EObject {
	/**
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Asset()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.khronos.collada.ProfileCGType#getAsset <em>Asset</em>}' containment reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Group()
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Code()
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Include()
   * @model containment="true" transient="true" volatile="true" derived="true"
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Group1()
   * @model unique="false" dataType="org.eclipse.emf.ecore.EFeatureMapEntry" many="true"
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Image()
   * @model containment="true" transient="true" volatile="true" derived="true"
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Newparam()
   * @model containment="true" transient="true" volatile="true" derived="true"
   ...
   * The list contents are of type {@link org.khronos.collada.TechniqueType}.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * <!-- begin-model-doc -->
   * 
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Technique()
   * @model containment="true" required="true"
   *        extendedMetaData="kind='element' name='technique' namespace='##targetNamespace'"
   * @generated
   */
	EList<TechniqueType> getTechnique();
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Extra()
   * @model containment="true"
   ...
   * @see #setId(String)
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Id()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.khronos.collada.ProfileCGType#getId <em>Id</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.khronos.collada.ColladaPackage#getProfileCGType_Platform()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.khronos.collada.ProfileCGType#getPlatform <em>Platform</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Unsets the value of the '{@link org.khronos.collada.ProfileCGType#getPlatform <em>Platform</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see #isSetPlatform()
   * @see #getPlatform()
   ...
   */
	...
	/**
   * Returns whether the value of the '{@link org.khronos.collada.ProfileCGType#getPlatform <em>Platform</em>}' attribute is set.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
