...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Ref Attachment Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.khronos.collada.RefAttachmentType#getGroup <em>Group</em>}</li>
 *   <li>{@link org.khronos.collada.RefAttachmentType#getTranslate <em>Translate</em>}</li>
 *   <li>{@link org.khronos.collada.RefAttachmentType#getRotate <em>Rotate</em>}</li>
 *   <li>{@link org.khronos.collada.RefAttachmentType#getExtra <em>Extra</em>}</li>
 *   <li>{@link org.khronos.collada.RefAttachmentType#getRigidBody <em>Rigid Body</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.khronos.collada.ColladaPackage#getRefAttachmentType()
 * @model extendedMetaData="name='ref_attachment_._type' kind='elementOnly'"
 * @generated
 */
public interface RefAttachmentType extends EObject {
	/**
   ...
   * @see org.khronos.collada.ColladaPackage#getRefAttachmentType_Group()
   ...
   * @see org.khronos.collada.ColladaPackage#getRefAttachmentType_Translate()
   ...
   * @see org.khronos.collada.ColladaPackage#getRefAttachmentType_Rotate()
   * @model containment="true" transient="true" volatile="true" derived="true"
   ...
   * @see org.khronos.collada.ColladaPackage#getRefAttachmentType_Extra()
   * @model containment="true" transient="true" volatile="true" derived="true"
   ...
   * @see org.khronos.collada.ColladaPackage#getRefAttachmentType_RigidBody()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.khronos.collada.RefAttachmentType#getRigidBody <em>Rigid Body</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
