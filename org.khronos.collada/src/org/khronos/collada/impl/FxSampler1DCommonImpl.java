...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fx Sampler1 DCommon</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getWrapS <em>Wrap S</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getMinfilter <em>Minfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getMagfilter <em>Magfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getMipfilter <em>Mipfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getMipmapMaxlevel <em>Mipmap Maxlevel</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getMipmapBias <em>Mipmap Bias</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler1DCommonImpl#getExtra <em>Extra</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FxSampler1DCommonImpl extends EObjectImpl implements FxSampler1DCommon {
	/**
   ...
   * @ordered
   */
	protected static final short MIPMAP_MAXLEVEL_EDEFAULT = 0;
   ...
   * @generated
   */
	protected FxSampler1DCommonImpl() {
    super();
  }
   ...
   */
    ...
    return ColladaPackage.eINSTANCE.getFxSampler1DCommon();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__SOURCE, oldSource, source));
  }
   ...
   */
    ...
    wrapSESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__WRAP_S, oldWrapS, wrapS, !oldWrapSESet));
  }
   ...
   */
    ...
    wrapSESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER1_DCOMMON__WRAP_S, oldWrapS, WRAP_S_EDEFAULT, oldWrapSESet));
  }
   ...
   */
    ...
    minfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__MINFILTER, oldMinfilter, minfilter, !oldMinfilterESet));
  }
   ...
   */
    ...
    minfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER1_DCOMMON__MINFILTER, oldMinfilter, MINFILTER_EDEFAULT, oldMinfilterESet));
  }
   ...
   */
    ...
    magfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__MAGFILTER, oldMagfilter, magfilter, !oldMagfilterESet));
  }
   ...
   */
    ...
    magfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER1_DCOMMON__MAGFILTER, oldMagfilter, MAGFILTER_EDEFAULT, oldMagfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__MIPFILTER, oldMipfilter, mipfilter, !oldMipfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER1_DCOMMON__MIPFILTER, oldMipfilter, MIPFILTER_EDEFAULT, oldMipfilterESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__BORDER_COLOR, oldBorderColor, borderColor));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, mipmapMaxlevel, !oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER1_DCOMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, MIPMAP_MAXLEVEL_EDEFAULT, oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    mipmapBiasESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER1_DCOMMON__MIPMAP_BIAS, oldMipmapBias, mipmapBias, !oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER1_DCOMMON__MIPMAP_BIAS, oldMipmapBias, MIPMAP_BIAS_EDEFAULT, oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (extra == null)
    {
      extra = new EObjectContainmentEList<ExtraType>(ExtraType.class, this, ColladaPackage.FX_SAMPLER1_DCOMMON__EXTRA);
    }
    return extra;
  }
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER1_DCOMMON__EXTRA:
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER1_DCOMMON__SOURCE:
        return getSource();
      case ColladaPackage.FX_SAMPLER1_DCOMMON__WRAP_S:
        return getWrapS();
      case ColladaPackage.FX_SAMPLER1_DCOMMON__MINFILTER:
        return getMinfilter();
      case ColladaPackage.FX_SAMPLER1_DCOMMON__MAGFILTER:
        return getMagfilter();
      case ColladaPackage.FX_SAMPLER1_DCOMMON__MIPFILTER:
        return getMipfilter();
      case ColladaPackage.FX_SAMPLER1_DCOMMON__BORDER_COLOR:
        return getBorderColor();
      case ColladaPackage.FX_SAMPLER1_DCOMMON__MIPMAP_MAXLEVEL:
        return getMipmapMaxlevel();
      case ColladaPackage.FX_SAMPLER1_DCOMMON__MIPMAP_BIAS:
