...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fx Sampler3 DCommon</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getWrapS <em>Wrap S</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getWrapT <em>Wrap T</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getWrapP <em>Wrap P</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getMinfilter <em>Minfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getMagfilter <em>Magfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getMipfilter <em>Mipfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getMipmapMaxlevel <em>Mipmap Maxlevel</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getMipmapBias <em>Mipmap Bias</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSampler3DCommonImpl#getExtra <em>Extra</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FxSampler3DCommonImpl extends EObjectImpl implements FxSampler3DCommon {
	/**
   ...
   * @generated
   */
	protected FxSampler3DCommonImpl() {
    super();
  }
   ...
   */
    ...
    return ColladaPackage.eINSTANCE.getFxSampler3DCommon();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__SOURCE, oldSource, source));
  }
   ...
   */
    ...
    wrapSESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_S, oldWrapS, wrapS, !oldWrapSESet));
  }
   ...
   */
    ...
    wrapSESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_S, oldWrapS, WRAP_S_EDEFAULT, oldWrapSESet));
  }
   ...
   */
    ...
    wrapTESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_T, oldWrapT, wrapT, !oldWrapTESet));
  }
   ...
   */
    ...
    wrapTESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_T, oldWrapT, WRAP_T_EDEFAULT, oldWrapTESet));
  }
   ...
   */
    ...
    wrapPESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_P, oldWrapP, wrapP, !oldWrapPESet));
  }
   ...
   */
    ...
    wrapPESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_P, oldWrapP, WRAP_P_EDEFAULT, oldWrapPESet));
  }
   ...
   */
    ...
    minfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__MINFILTER, oldMinfilter, minfilter, !oldMinfilterESet));
  }
   ...
   */
    ...
    minfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__MINFILTER, oldMinfilter, MINFILTER_EDEFAULT, oldMinfilterESet));
  }
   ...
   */
    ...
    magfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__MAGFILTER, oldMagfilter, magfilter, !oldMagfilterESet));
  }
   ...
   */
    ...
    magfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__MAGFILTER, oldMagfilter, MAGFILTER_EDEFAULT, oldMagfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__MIPFILTER, oldMipfilter, mipfilter, !oldMipfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__MIPFILTER, oldMipfilter, MIPFILTER_EDEFAULT, oldMipfilterESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__BORDER_COLOR, oldBorderColor, borderColor));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, mipmapMaxlevel, !oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, MIPMAP_MAXLEVEL_EDEFAULT, oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    mipmapBiasESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER3_DCOMMON__MIPMAP_BIAS, oldMipmapBias, mipmapBias, !oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER3_DCOMMON__MIPMAP_BIAS, oldMipmapBias, MIPMAP_BIAS_EDEFAULT, oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (extra == null)
    {
      extra = new EObjectContainmentEList<ExtraType>(ExtraType.class, this, ColladaPackage.FX_SAMPLER3_DCOMMON__EXTRA);
    }
    return extra;
  }
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER3_DCOMMON__EXTRA:
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER3_DCOMMON__SOURCE:
        return getSource();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_S:
        return getWrapS();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_T:
        return getWrapT();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__WRAP_P:
        return getWrapP();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__MINFILTER:
        return getMinfilter();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__MAGFILTER:
        return getMagfilter();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__MIPFILTER:
        return getMipfilter();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__BORDER_COLOR:
        return getBorderColor();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__MIPMAP_MAXLEVEL:
        return getMipmapMaxlevel();
      case ColladaPackage.FX_SAMPLER3_DCOMMON__MIPMAP_BIAS:
