...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fx Sampler CUBE Common</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getWrapS <em>Wrap S</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getWrapT <em>Wrap T</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getWrapP <em>Wrap P</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getMinfilter <em>Minfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getMagfilter <em>Magfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getMipfilter <em>Mipfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getMipmapMaxlevel <em>Mipmap Maxlevel</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getMipmapBias <em>Mipmap Bias</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerCUBECommonImpl#getExtra <em>Extra</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FxSamplerCUBECommonImpl extends EObjectImpl implements FxSamplerCUBECommon {
	/**
   ...
   */
	...
	/**
   * The default value of the '{@link #getWrapP() <em>Wrap P</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see #getWrapP()
   * @generated
   * @ordered
   */
	protected static final FxSamplerWrapCommon WRAP_P_EDEFAULT = FxSamplerWrapCommon.WRAP;

	/**
   * The cached value of the '{@link #getWrapP() <em>Wrap P</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @see #getWrapP()
   * @generated
   * @ordered
   */
	protected FxSamplerWrapCommon wrapP = WRAP_P_EDEFAULT;

	/**
   * This is true if the Wrap P attribute has been set.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
	protected boolean wrapPESet;
   ...
   * @generated
   */
	protected FxSamplerCUBECommonImpl() {
    super();
  }
   ...
   */
    ...
    return ColladaPackage.eINSTANCE.getFxSamplerCUBECommon();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__SOURCE, oldSource, source));
  }
   ...
   */
    ...
    wrapSESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_S, oldWrapS, wrapS, !oldWrapSESet));
  }
   ...
   */
    ...
    wrapSESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_S, oldWrapS, WRAP_S_EDEFAULT, oldWrapSESet));
  }
   ...
   */
    ...
    wrapTESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_T, oldWrapT, wrapT, !oldWrapTESet));
  }
   ...
   */
    ...
    wrapTESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_T, oldWrapT, WRAP_T_EDEFAULT, oldWrapTESet));
  }
   ...
   * @generated
   */
	public void setWrapP(FxSamplerWrapCommon newWrapP) {
    FxSamplerWrapCommon oldWrapP = wrapP;
    wrapP = newWrapP == null ? WRAP_P_EDEFAULT : newWrapP;
    boolean oldWrapPESet = wrapPESet;
    wrapPESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_P, oldWrapP, wrapP, !oldWrapPESet));
  }
   ...
   * @generated
   */
	public void unsetWrapP() {
    FxSamplerWrapCommon oldWrapP = wrapP;
    boolean oldWrapPESet = wrapPESet;
    wrapP = WRAP_P_EDEFAULT;
    wrapPESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_P, oldWrapP, WRAP_P_EDEFAULT, oldWrapPESet));
  }
   ...
   */
    ...
    minfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MINFILTER, oldMinfilter, minfilter, !oldMinfilterESet));
  }
   ...
   */
    ...
    minfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MINFILTER, oldMinfilter, MINFILTER_EDEFAULT, oldMinfilterESet));
  }
   ...
   */
    ...
    magfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MAGFILTER, oldMagfilter, magfilter, !oldMagfilterESet));
  }
   ...
   */
    ...
    magfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MAGFILTER, oldMagfilter, MAGFILTER_EDEFAULT, oldMagfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPFILTER, oldMipfilter, mipfilter, !oldMipfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPFILTER, oldMipfilter, MIPFILTER_EDEFAULT, oldMipfilterESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__BORDER_COLOR, oldBorderColor, borderColor));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, mipmapMaxlevel, !oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, MIPMAP_MAXLEVEL_EDEFAULT, oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    mipmapBiasESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPMAP_BIAS, oldMipmapBias, mipmapBias, !oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPMAP_BIAS, oldMipmapBias, MIPMAP_BIAS_EDEFAULT, oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (extra == null)
    {
      extra = new EObjectContainmentEList<ExtraType>(ExtraType.class, this, ColladaPackage.FX_SAMPLER_CUBE_COMMON__EXTRA);
    }
    return extra;
  }
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__EXTRA:
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__SOURCE:
        return getSource();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_S:
        return getWrapS();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_T:
        return getWrapT();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_P:
        return getWrapP();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__MINFILTER:
        return getMinfilter();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__MAGFILTER:
        return getMagfilter();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPFILTER:
        return getMipfilter();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__BORDER_COLOR:
        return getBorderColor();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPMAP_MAXLEVEL:
        return getMipmapMaxlevel();
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__MIPMAP_BIAS:
   ...
   */
    ...
    switch (featureID)
    {
      ...
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_T:
        ...
        return;
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__WRAP_P:
        setWrapP((FxSamplerWrapCommon)newValue);
        return;
      case ColladaPackage.FX_SAMPLER_CUBE_COMMON__MINFILTER:
   ...
   */
    ...
    result.append(", wrapP: ");
    if (wrapPESet) result.append(wrapP); else result.append("<unset>");
