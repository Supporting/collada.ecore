...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fx Sampler RECT Common</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getWrapS <em>Wrap S</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getWrapT <em>Wrap T</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getMinfilter <em>Minfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getMagfilter <em>Magfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getMipfilter <em>Mipfilter</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getBorderColor <em>Border Color</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getMipmapMaxlevel <em>Mipmap Maxlevel</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getMipmapBias <em>Mipmap Bias</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxSamplerRECTCommonImpl#getExtra <em>Extra</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FxSamplerRECTCommonImpl extends EObjectImpl implements FxSamplerRECTCommon {
	/**
   ...
   * @generated
   */
	protected FxSamplerRECTCommonImpl() {
    super();
  }
   ...
   */
    ...
    return ColladaPackage.eINSTANCE.getFxSamplerRECTCommon();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__SOURCE, oldSource, source));
  }
   ...
   */
    ...
    wrapSESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__WRAP_S, oldWrapS, wrapS, !oldWrapSESet));
  }
   ...
   */
    ...
    wrapSESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_RECT_COMMON__WRAP_S, oldWrapS, WRAP_S_EDEFAULT, oldWrapSESet));
  }
   ...
   */
    ...
    wrapTESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__WRAP_T, oldWrapT, wrapT, !oldWrapTESet));
  }
   ...
   */
    ...
    wrapTESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_RECT_COMMON__WRAP_T, oldWrapT, WRAP_T_EDEFAULT, oldWrapTESet));
  }
   ...
   */
    ...
    minfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MINFILTER, oldMinfilter, minfilter, !oldMinfilterESet));
  }
   ...
   */
    ...
    minfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MINFILTER, oldMinfilter, MINFILTER_EDEFAULT, oldMinfilterESet));
  }
   ...
   */
    ...
    magfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MAGFILTER, oldMagfilter, magfilter, !oldMagfilterESet));
  }
   ...
   */
    ...
    magfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MAGFILTER, oldMagfilter, MAGFILTER_EDEFAULT, oldMagfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPFILTER, oldMipfilter, mipfilter, !oldMipfilterESet));
  }
   ...
   */
    ...
    mipfilterESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPFILTER, oldMipfilter, MIPFILTER_EDEFAULT, oldMipfilterESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__BORDER_COLOR, oldBorderColor, borderColor));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, mipmapMaxlevel, !oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPMAP_MAXLEVEL, oldMipmapMaxlevel, MIPMAP_MAXLEVEL_EDEFAULT, oldMipmapMaxlevelESet));
  }
   ...
   */
    ...
    mipmapBiasESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPMAP_BIAS, oldMipmapBias, mipmapBias, !oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPMAP_BIAS, oldMipmapBias, MIPMAP_BIAS_EDEFAULT, oldMipmapBiasESet));
  }
   ...
   */
    ...
    if (extra == null)
    {
      extra = new EObjectContainmentEList<ExtraType>(ExtraType.class, this, ColladaPackage.FX_SAMPLER_RECT_COMMON__EXTRA);
    }
    return extra;
  }
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__EXTRA:
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__SOURCE:
        return getSource();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__WRAP_S:
        return getWrapS();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__WRAP_T:
        return getWrapT();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__MINFILTER:
        return getMinfilter();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__MAGFILTER:
        return getMagfilter();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPFILTER:
        return getMipfilter();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__BORDER_COLOR:
        return getBorderColor();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPMAP_MAXLEVEL:
        return getMipmapMaxlevel();
      case ColladaPackage.FX_SAMPLER_RECT_COMMON__MIPMAP_BIAS:
