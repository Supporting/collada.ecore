...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Fx Colortarget Common</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.khronos.collada.impl.FxColortargetCommonImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxColortargetCommonImpl#getFace <em>Face</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxColortargetCommonImpl#getIndex <em>Index</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxColortargetCommonImpl#getMip <em>Mip</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FxColortargetCommonImpl#getSlice <em>Slice</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FxColortargetCommonImpl extends EObjectImpl implements FxColortargetCommon {
	/**
   ...
   * @generated
   */
	protected FxColortargetCommonImpl() {
    super();
  }
   ...
   */
    ...
    return ColladaPackage.eINSTANCE.getFxColortargetCommon();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_COLORTARGET_COMMON__VALUE, oldValue, value));
  }
   ...
   */
    ...
    faceESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_COLORTARGET_COMMON__FACE, oldFace, face, !oldFaceESet));
  }
   ...
   */
    ...
    faceESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_COLORTARGET_COMMON__FACE, oldFace, FACE_EDEFAULT, oldFaceESet));
  }
   ...
   */
    ...
    indexESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_COLORTARGET_COMMON__INDEX, oldIndex, index, !oldIndexESet));
  }
   ...
   */
    ...
    indexESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_COLORTARGET_COMMON__INDEX, oldIndex, INDEX_EDEFAULT, oldIndexESet));
  }
   ...
   */
    ...
    mipESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_COLORTARGET_COMMON__MIP, oldMip, mip, !oldMipESet));
  }
   ...
   */
    ...
    mipESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_COLORTARGET_COMMON__MIP, oldMip, MIP_EDEFAULT, oldMipESet));
  }
   ...
   */
    ...
    sliceESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FX_COLORTARGET_COMMON__SLICE, oldSlice, slice, !oldSliceESet));
  }
   ...
   */
    ...
    sliceESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FX_COLORTARGET_COMMON__SLICE, oldSlice, SLICE_EDEFAULT, oldSliceESet));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FX_COLORTARGET_COMMON__VALUE:
        return getValue();
      case ColladaPackage.FX_COLORTARGET_COMMON__FACE:
        return getFace();
      case ColladaPackage.FX_COLORTARGET_COMMON__INDEX:
        return getIndex();
      case ColladaPackage.FX_COLORTARGET_COMMON__MIP:
        return getMip();
      case ColladaPackage.FX_COLORTARGET_COMMON__SLICE:
        return getSlice();
    }
