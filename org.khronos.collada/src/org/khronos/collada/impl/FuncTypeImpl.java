 ...
 * <ul>
 *   <li>{@link org.khronos.collada.impl.FuncTypeImpl#getParam <em>Param</em>}</li>
 *   <li>{@link org.khronos.collada.impl.FuncTypeImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FuncTypeImpl extends EObjectImpl implements FuncType {
	/**
   ...
   */
    ...
    return ColladaPackage.eINSTANCE.getFuncType();
  }
   ...
   */
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FUNC_TYPE__PARAM, oldParam, param));
  }
   ...
   */
    ...
    valueESet = true;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ColladaPackage.FUNC_TYPE__VALUE, oldValue, value, !oldValueESet));
  }
   ...
   */
    ...
    valueESet = false;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.UNSET, ColladaPackage.FUNC_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
  }
   ...
   */
    ...
    switch (featureID)
    {
      case ColladaPackage.FUNC_TYPE__PARAM:
        return getParam();
      case ColladaPackage.FUNC_TYPE__VALUE:
        return getValue();
    }
