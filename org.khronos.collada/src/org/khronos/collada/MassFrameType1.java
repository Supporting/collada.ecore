...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Mass Frame Type1</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.khronos.collada.MassFrameType1#getGroup <em>Group</em>}</li>
 *   <li>{@link org.khronos.collada.MassFrameType1#getTranslate <em>Translate</em>}</li>
 *   <li>{@link org.khronos.collada.MassFrameType1#getRotate <em>Rotate</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.khronos.collada.ColladaPackage#getMassFrameType1()
 * @model extendedMetaData="name='mass_frame_._1_._type' kind='elementOnly'"
 * @generated
 */
public interface MassFrameType1 extends EObject {
	/**
   ...
   * @see org.khronos.collada.ColladaPackage#getMassFrameType1_Group()
   ...
   * @see org.khronos.collada.ColladaPackage#getMassFrameType1_Translate()
   ...
   * @see org.khronos.collada.ColladaPackage#getMassFrameType1_Rotate()
   * @model containment="true" transient="true" volatile="true" derived="true"
