...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Trifans Type</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
 * The following features are supported:
 * <ul>
 *   <li>{@link org.khronos.collada.TrifansType#getInput <em>Input</em>}</li>
 *   <li>{@link org.khronos.collada.TrifansType#getP <em>P</em>}</li>
 *   <li>{@link org.khronos.collada.TrifansType#getExtra <em>Extra</em>}</li>
 *   <li>{@link org.khronos.collada.TrifansType#getCount <em>Count</em>}</li>
 *   <li>{@link org.khronos.collada.TrifansType#getMaterial <em>Material</em>}</li>
 *   <li>{@link org.khronos.collada.TrifansType#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.khronos.collada.ColladaPackage#getTrifansType()
 * @model extendedMetaData="name='trifans_._type' kind='elementOnly'"
 * @generated
 */
public interface TrifansType extends EObject {
	/**
   ...
   * @see org.khronos.collada.ColladaPackage#getTrifansType_Input()
   ...
   * @see org.khronos.collada.ColladaPackage#getTrifansType_P()
   ...
   * @see org.khronos.collada.ColladaPackage#getTrifansType_Extra()
   * @model containment="true"
   ...
   * @see org.khronos.collada.ColladaPackage#getTrifansType_Count()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.khronos.collada.TrifansType#getCount <em>Count</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see org.khronos.collada.ColladaPackage#getTrifansType_Material()
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.khronos.collada.TrifansType#getMaterial <em>Material</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   ...
   * @see #setName(String)
   * @see org.khronos.collada.ColladaPackage#getTrifansType_Name()
   * @model dataType="org.eclipse.emf.ecore.xml.type.NCName"
   ...
   */
	...
	/**
   * Sets the value of the '{@link org.khronos.collada.TrifansType#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
